...
const UploadImg = () => {
    ...
    const fileUploadSubmition=(e)=>{
        ...
        form.set("avatar",e.target[0].value)
    ...
    const FileChangeHandler=()=>{
        ...
        // fileForm.current.onSubmit(fileUploadSubmition);
        fileForm?.current.dispatchEvent(
            new Event("submit", { cancelable: true, bubbles: true })
          );
        // fileForm.current.submit.preventDefault()
    }
  return (
    <>
    ...
    <Paper elevation={0}>
      ...
      <FormControl sx={{ m: 1, width: '25ch' }} variant="outlined">
          ...
          <Button variant="contained" disabled={!checked?false:true}>Submit</Button>
          </FormControl>
      <Divider variant="middle" orientation="vertical" flexItem />
       <form onSubmit={(e)=>fileUploadSubmition(e)} ref={fileForm}>
        ...
        Upload
       <input hidden accept="image/*" name="avatar" multiple type="file" onChange={FileChangeHandler} />
      </Button>
       </form>
